...
<div id='continue' style="display:none;">
    <lv-snapper>   
        ...
        <lv-snapper-content class="snap-content">
        	<div class="" id="toolbar" class="navbar-fixed-top">
                <div class="">
                        <lv-snapper-toggler side="left" class="pull-left menu"><a href=""><i class="icon-reorder"> {{menutext}}</i></a></lv-snapper-toggler>
